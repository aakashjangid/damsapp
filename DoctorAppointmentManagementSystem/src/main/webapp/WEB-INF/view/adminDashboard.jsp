			...
			<div class="col-md-4">
				...
				<p>
					<a class="btn btn-secondary"
						href="../appointment/adminAppointmentsPage.htm" role="button">Show All
						Appointment &raquo;</a>
				</p>
			</div>
			<div class="col-md-4">
				...
				<p>Donec id elit non mi porta gravida at eget metus. Fusce
					...
					magna mollis euismod. Donec sed odio dui.</p>
				<p>
					<a class="btn btn-secondary" href="../user/userList.htm" role="button">Show All
						Patients &raquo;</a>
				</p>
			</div>
			<div class="col-md-4">
				...
				<p>
					<a class="btn btn-secondary" href="#" role="button">Complete Payment &raquo;</a>
				</p>
			</div>
		</div>
